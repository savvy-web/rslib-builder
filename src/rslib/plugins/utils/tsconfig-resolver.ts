...
// ============================================================================
// Backward-compatible function exports (delegate to class methods)
// ============================================================================
 ...
 * {@link TsconfigResolver.convertScriptTarget}.
 *
 * @param target - The ScriptTarget enum value
 * @returns The string representation (e.g., "es2022", "esnext")
 *
 * @public
 */
export function convertScriptTarget(target: ScriptTarget | undefined): string | undefined {
	return TsconfigResolver.convertScriptTarget(target);
}
 ...
 * @remarks
 * This is a convenience function that delegates to
 * {@link TsconfigResolver.convertModuleKind}.
 *
 * @param module - The ModuleKind enum value
 * @returns The string representation (e.g., "nodenext", "esnext")
 *
 * @public
 */
export function convertModuleKind(module: ModuleKind | undefined): string | undefined {
	return TsconfigResolver.convertModuleKind(module);
}
 ...
 * @remarks
 * This is a convenience function that delegates to
 * {@link TsconfigResolver.convertModuleResolution}.
 *
 * @param resolution - The ModuleResolutionKind enum value
 * @returns The string representation (e.g., "nodenext", "bundler")
 *
 * @public
 */
export function convertModuleResolution(resolution: ModuleResolutionKind | undefined): string | undefined {
	return TsconfigResolver.convertModuleResolution(resolution);
}
 ...
 * @remarks
 * This is a convenience function that delegates to
 * {@link TsconfigResolver.convertJsxEmit}.
 *
 * @param jsx - The JsxEmit enum value
 * @returns The string representation (e.g., "react-jsx", "preserve")
 *
 * @public
 */
export function convertJsxEmit(jsx: JsxEmit | undefined): string | undefined {
	return TsconfigResolver.convertJsxEmit(jsx);
}
 ...
 * @remarks
 * This is a convenience function that delegates to
 * {@link TsconfigResolver.convertModuleDetection}.
 *
 * @param detection - The ModuleDetectionKind enum value
 * @returns The string representation (e.g., "auto", "force")
 *
 * @public
 */
export function convertModuleDetection(detection: ModuleDetectionKind | undefined): string | undefined {
	return TsconfigResolver.convertModuleDetection(detection);
}
 ...
 * @remarks
 * This is a convenience function that delegates to
 * {@link TsconfigResolver.convertNewLine}.
 *
 * @param newLine - The NewLineKind enum value
 * @returns The string representation (e.g., "lf", "crlf")
 *
 * @public
 */
export function convertNewLine(newLine: NewLineKind | undefined): string | undefined {
	return TsconfigResolver.convertNewLine(newLine);
}
 ...
 *
 * This is a convenience function that delegates to
 * {@link TsconfigResolver.convertImportsNotUsedAsValues}.
 *
 * @param importsNotUsedAsValues - The ImportsNotUsedAsValues enum value
 * @returns The string representation (e.g., "remove", "preserve", "error")
 *
 * @public
 */
export function convertImportsNotUsedAsValues(
	importsNotUsedAsValues: ImportsNotUsedAsValues | undefined,
): string | undefined {
	return TsconfigResolver.convertImportsNotUsedAsValues(importsNotUsedAsValues);
}
 ...
 * @remarks
 * This is a convenience function that delegates to
 * {@link TsconfigResolver.convertLibReference}.
 *
 * @param lib - The lib reference (e.g., "lib.esnext.d.ts" or "/path/to/lib.dom.d.ts")
 * @returns The canonical name (e.g., "esnext", "dom")
 *
 * @public
 */
export function convertLibReference(lib: string): string {
	return TsconfigResolver.convertLibReference(lib);
}

/**
 * Normalizes an absolute path to a relative path from rootDir.
 *
 * @remarks
 * This is a convenience function that delegates to
 * {@link TsconfigResolver.normalizePathToRelative}.
 *
 * @param path - The absolute path to normalize
 * @param rootDir - The root directory to make paths relative to
 * @returns The relative path, or the original path if not absolute
 *
 * @public
 */
export function normalizePathToRelative(path: string | undefined, rootDir: string): string | undefined {
	return TsconfigResolver.normalizePathToRelative(path, rootDir);
}

/**
 * Converts a TypeScript ParsedCommandLine to a JSON-serializable tsconfig object.
 *
 * @remarks
 * This is a convenience function that creates a {@link TsconfigResolver}
 * instance and calls its `resolve` method.
 *
 * This function takes the parsed TypeScript configuration and converts it back
 * to a format suitable for writing to a tsconfig.json file. It handles:
 *
 * - Converting enum values (target, module, moduleResolution, jsx) to strings
 * - Converting lib array format (lib.esnext.d.ts to esnext)
 * - Setting `composite: false` and `noEmit: true` for virtual environments
 * - Adding $schema for IDE support
 *
 * @param parsed - The parsed TypeScript configuration from parseJsonConfigFileContent
 * @param rootDir - The root directory to make paths relative to
 * @returns A JSON-serializable tsconfig object
 ...
 * ```typescript
 * import { parseJsonConfigFileContent, readConfigFile, sys } from 'typescript';
 * import { convertParsedConfigToJson } from '@savvy-web/rslib-builder';
 *
 * const configFile = readConfigFile('tsconfig.json', sys.readFile.bind(sys));
 * const parsed = parseJsonConfigFileContent(configFile.config, sys, process.cwd());
 * const resolved = convertParsedConfigToJson(parsed, process.cwd());
 *
 * console.log(JSON.stringify(resolved, null, 2));
 * ```
 *
 * @public
 */
export function convertParsedConfigToJson(parsed: ParsedCommandLine, rootDir: string): ResolvedTsconfig {
	const resolver = new TsconfigResolver();
	return resolver.resolve(parsed, rootDir);
}
